                    ...
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form action="{{ url('appointment_store') }}" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input name="email" class="form-control bg-light border-0" placeholder="Your Email" style="height: 55px;">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="btn btn-dark w-100 py-3">Login to Request A Quote</a>
                                    @endif
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            ...
                            <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="">{{$data->tag}}</a>
                        </div>
                        <div class="p-4">
                            <div class="d-flex mb-3 justify-content-between">
                                <p class="me-3"><i class="far fa-user text-primary me-2"></i>{{$data->author_name}}</p>
                                <p><i class="far fa-calendar-alt text-primary me-2"></i>{{Carbon\Carbon::parse($data->created_at)->Format('d M, Y')}}
                                </p>
                            </div>
